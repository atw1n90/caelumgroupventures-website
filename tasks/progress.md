...
- Added the supplied favicon set under `favicons/`.
- Added the supplied brand kit under `brand/`.
- Updated `index.html` so the root page and bundled page metadata reference the new favicon files.
